...
- click (Team 2020), as well as Quarto (Allaire et al. 2022). 
...
_Figure 1: Horse populations for all provinces in Canada from 1906 - 1972.

We can see from Figure @fig-horse-pop that Ontario, Saskatchewan, and Alberta have the highest horse populations in Canada.
...
An interesting follow-up visualisation would be car sales per year for each Province over the time period visualised above to further support this hypothesis.
Suppose we were interested in looking in more closely at the province with the highest spread (in terms of standard deviation) of horse populations. 
...
_Figure 2: Horse populations for the province with the largest standard deviation._
```{python}
largest_sd = "Alberta"
```
